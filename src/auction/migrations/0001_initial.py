    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'membership',
                    models.CharField(choices=[('B', 'Bronze'), ('S', 'Silver'), ('G', 'Gold')], default='B', max_length=1),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'current_price',
                    models.DecimalField(
                        decimal_places=2, default=models.DecimalField(decimal_places=2, max_digits=10), max_digits=10
                    ),
                ),
                ...
                (
                    'auction_status',
                    models.CharField(
                        choices=[('A', 'Active'), ('C', 'Completed'), ('X', 'Cancelled'), ('S', 'Schedule'), ('D', 'Deleted')],
                        default='A',
                        max_length=1,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'notification_type',
                    models.CharField(choices=[('I', 'Info'), ('W', 'Warning'), ('E', 'Error')], default='I', max_length=1),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'price',
                    models.DecimalField(
                        decimal_places=2, max_digits=10, validators=[django.core.validators.MinValueValidator(Decimal('1'))]
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'transaction_status',
                    models.CharField(choices=[('C', 'Completed'), ('P', 'Pending'), ('X', 'Cancelled')], max_length=1),
                ),
                ('created_at', models.DateTimeField(auto_now_add=True)),
            ],
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='auction.customer'
                    ),
                ),
            ],
            options={
